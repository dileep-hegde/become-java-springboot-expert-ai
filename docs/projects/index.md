...
id: projects-index
title: Projects
description: End-to-end Java Spring Boot project walkthroughs — annotated source code deep-dives for interview preparation and real-world learning.
sidebar_position: 1
tags:
  - java
  - spring-boot
...
| Project | Description |
|---------|-------------|
| [Loan Application Evaluator](./loan-application-evaluator/index.md) | Spring Boot REST API that evaluates loan applications using risk classification, EMI calculation, and eligibility rules. Covers layered architecture, JPA embedded objects, validation, and Mockito-based unit tests. |
